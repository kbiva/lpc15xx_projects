...
void task_LED1_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED1_PIN);
    tn_task_sleep(1000);
  }
}
...
void task_LED2_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED2_PIN);
    tn_task_sleep(50);
  }
}
...
void task_LED3_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED3_PIN);
    tn_task_sleep(100);
  }
}
...
void task_LED4_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED4_PIN);
    tn_task_sleep(200);
  }
}
...
void task_LED5_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED5_PIN);
    tn_task_sleep(400);
  }
}
...
void task_LED6_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED6_PIN);
    tn_task_sleep(800);
  }
}
...
void task_LED7_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED7_PIN);
    tn_task_sleep(1600);
  }
}
...
void task_LED8_body(void *par) {
  ...
  for(;;) {
    Chip_GPIO_SetPinToggle(LPC_GPIO, 0, LED8_PIN);
    tn_task_sleep(3200);
  }
}
...
void appl_init(void) {
  ...
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED1_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED2_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED3_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED4_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED5_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED6_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED7_PIN);
  Chip_GPIO_SetPinDIROutput(LPC_GPIO, 0, LED8_PIN);
